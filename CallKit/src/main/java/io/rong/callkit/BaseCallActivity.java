 ...
 */
public class BaseCallActivity extends AppCompatActivity implements IRongCallListener, PickupDetector.PickupDetectListener {
    ...
    protected SurfaceView mLocalVideo = null;
    protected SurfaceView mRemoteVideo = null;
    ...
    private CallFloatWindow mCallFloatView;
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals(Intent.ACTION_CLOSE_SYSTEM_DIALOGS)) {
                    ...
                    if (SYSTEM_DIALOG_REASON_HOME_KEY.equals(reason) && shouldShowFloat) {
                        if (SettingAlertPermission.hasPermission(BaseCallActivity.this)) {
                            finish();
                        }else{
                            showOnGoingNotification(getString(R.string.rc_call_on_going),getString(R.string.rc_call_on_going_again));
                            Toast.makeText(BaseCallActivity.this, R.string.no_float_window_permission, Toast.LENGTH_LONG).show();
                        }
                    }
                }
            }
    ...
    protected void onStart() {
        super.onStart();
        RLog.d(TAG, "BaseCallActivity onStart");
    ...
    public void onOutgoingCallRinging() {
        RLog.d(TAG, "BaseCallActivity onOutgoingCallRinging");
    ...
    public void onIncomingCallRinging() {
        RLog.d(TAG, "BaseCallActivity onIncomingCallRinging");
    ...
    public void setupTime(final TextView timeView) {
        RLog.d(TAG, "BaseCallActivity setupTime");
    ...
    public void stopRing() {
        RLog.d(TAG, "BaseCallActivity stopRing");
    ...
    public void onCallOutgoing(RongCallSession callProfile, SurfaceView localVideo) {
        RLog.d(TAG, "BaseCallActivity onCallOutgoing");
    }

    @Override
    public void onRemoteUserRinging(String userId) {
        RLog.d(TAG, "BaseCallActivity onRemoteUserRinging");

    }

    @Override
    public void onCallDisconnected(RongCallSession callProfile, RongCallCommon.CallDisconnectedReason reason) {
        RLog.d(TAG, "BaseCallActivity onCallDisconnected");
    ...
    public void onRemoteUserInvited(String userId, RongCallCommon.CallMediaType mediaType) {
        RLog.d(TAG, "BaseCallActivity onRemoteUserInvited");
        if (RongCallKit.getCustomerHandlerListener() != null) {
    ...
    public void onRemoteUserJoined(String userId, RongCallCommon.CallMediaType mediaType, SurfaceView remoteVideo) {
        RLog.d(TAG, "BaseCallActivity onRemoteUserJoined");
    ...
    public void onRemoteUserLeft(String userId, RongCallCommon.CallDisconnectedReason reason) {
        RLog.d(TAG, "BaseCallActivity onRemoteUserLeft");

    }

    @Override
    public void onMediaTypeChanged(String userId, RongCallCommon.CallMediaType mediaType, SurfaceView video) {
        RLog.d(TAG, "BaseCallActivity onMediaTypeChanged");
    ...
    public void onCallConnected(RongCallSession callProfile, SurfaceView localVideo) {
        RLog.d(TAG, "BaseCallActivity onCallConnected");
        if (RongCallKit.getCustomerHandlerListener() != null) {
    ...
    protected void onPause() {
        RLog.d(TAG, "BaseCallActivity onPause");
        ...
        if (isFinishing) {
            ...
            if (shouldShowFloat) {
                ...
                if (action != null) {
                    ...
                    getCallFloatView().show(bundle, getVideoView());
    ...
    public CallFloatWindow getCallFloatView() {
        if (mCallFloatView == null) {
            mCallFloatView = new CallFloatWindow(getApplicationContext());
        }
        return mCallFloatView;
    }
...
//            CallFloatBoxView.hideFloatBox();
            RLog.d(TAG, "getCallFloatView hide onResume");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        RLog.d(TAG, "BaseCallActivity onActivityResult");
    ...
    public void onRemoteCameraDisabled(String userId, boolean disabled) {
        RLog.d(TAG, "BaseCallActivity onRemoteCameraDisabled");

    }

    public void onRestoreFloatBox(Bundle bundle) {
        RLog.d(TAG, "BaseCallActivity onRestoreFloatBox");
    ...
    public String onSaveFloatBoxState(Bundle bundle) {
        RLog.d(TAG, "BaseCallActivity onSaveFloatBoxState");
        return null;
    }

    public void showOnGoingNotification(String title, String content) {
        RLog.d(TAG, "BaseCallActivity showOnGoingNotification");
