...
public class MultiAudioCallActivity extends BaseCallActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        incomingController = (FrameLayout) LayoutInflater.from(this).inflate(R.layout.layout_incoming_button, null);
    ...
    void initView() {
        ...
        if (callAction.equals(RongCallAction.ACTION_INCOMING_CALL)) {
            ...
            AsyncImageView userPortrait = (AsyncImageView) incomingLayout.findViewById(R.id.iv_user_header);
