...
public class MultiVideoCallActivity extends BaseCallActivity {
        ...
        if (bundle != null) {
            ...
            for (CallUserProfile profile : callSession.getParticipantProfileList()) {
                ...
                if (profile.getUserId().equals(localViewUserId)
                    ...
                    TextView userNameView = (TextView) topContainer.findViewById(R.id.tv_user_name);
    ...
    public void onRemoteUserLeft(String userId, RongCallCommon.CallDisconnectedReason reason) {
        ...
        if (localViewUserId.equals(userId)) {
            ...
            TextView topUserNameView = (TextView) topContainer.findViewById(R.id.tv_user_name);
    ...
    public void onCallConnected(RongCallSession callSession, SurfaceView localVideo) {
        ...
        TextView remindInfo = (TextView) topContainer.findViewById(R.id.tv_remind_info);
...
//        remoteVideoView.addView(remoteNameTextView);
    ...
    protected void initViews() {
        ...
        userPortrait = (AsyncImageView) findViewById(R.id.iv_user_header);
    ...
    protected void setupIntent() {
        ...
        if (callAction.equals(RongCallAction.ACTION_INCOMING_CALL)) {
            ...
            TextView callRemindInfoView = (TextView) topContainer.findViewById(R.id.tv_remind_info);
            TextView userNameView = (TextView) topContainer.findViewById(R.id.tv_user_name);
...
//                    if (!profile.getUserId().equals(callSession.getSelfUserId()))
                ...
                FrameLayout bottomButtonLayout = (FrameLayout) inflater.inflate(R.layout.layout_incoming_button, null);
