...
//        mLineSpace = (this.getResources().getDisplayMetrics().heightPixels - mTextSize * 26) / 24;
...
//            mTextColor = a.getColor(R.styleable.IndexView_textColor, DEFAULT_TEXT_COLOR);
            mTextColor = Color.parseColor("#8a8a8a");
//            mTextSize = 40;
...
//            mLineSpace = (this.getResources().getDisplayMetrics().heightPixels - mTextSize * 26) / 30;
