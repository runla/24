 ...
 * @date Created on：2017/10/24 18:22
 * @Describe： 已完成订单的适配器
 */

public class CompleteOrderAdapter extends BaseMultiAdapter<OrderBean.DataBean.TfOrderListBean> implements OnAdapterListener {
    ...
    public CompleteOrderAdapter(Context context, OnAdapterListener listener) {
        super(context);
