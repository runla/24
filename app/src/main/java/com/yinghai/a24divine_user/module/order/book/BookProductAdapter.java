...
public class BookProductAdapter extends BaseDataAdapter<ProductOrderListBean.DataBean.TfOrderListBean> {
    ...
    public BookProductAdapter(Context context, OnAdapterListener listener) {
        super(context);
