 ...
 *         Created Time: 2017/12/13 14:35
 *         Describe：
 */

public class CompleteProductAdapter extends BaseDataAdapter<ProductOrderListBean.DataBean.TfOrderListBean> {
    ...
    public CompleteProductAdapter(Context context, OnAdapterListener listener) {
        super(context);
